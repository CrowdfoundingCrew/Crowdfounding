...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-md-4">
            ...
            <address>
                <strong>Twitter, Inc.</strong><br /> 8453 O'Keefe Rapid<br /> North Layla, 17932-3467<br />
            </address>
            <h5>
                telefono: 486-346-2955
            </h5>
        ...
        <div class="col-md-4">
            ...
            <address>
                <strong>Apple, Inc.</strong><br /> 69974 Vivien Grove<br /> Port Nia, 96085<br />
            </address>
            <h5>
                telefono: 649-6366-467
            </h5>
            <img alt="Icon" src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRQP50pXiubgStZ2CNuJPkQXFpdP-U7PU3VDROqeWYPOgff6Vk_JvomaUJNHczs4wV--HI&usqp=CAU" width="300px" height="300px"/>
        </div>
    </div>
