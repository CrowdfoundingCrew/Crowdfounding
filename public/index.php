...
<div class="container mt-5">
    ...
    <hr class="featurette-divider">
    <div class="row mb-4">
        <?php foreach ($onlus as $row) { ?>
            <div class="col-lg-4">
                <img alt='Logo' src="<?= $row["Immagine"] ?>" class='rounded-circle' widht='140px' height='140px' />
                <h3><?= $row['Denominazione'] ?></h3>
                <p><label><i class="fas fa-envelope"></i>E-mail:</label> <?= $row['E-mail'] ?><br><label><i class="fas fa-map-marker-alt"></i>Indirizzo:</label> <?= $row['Indirizzo'] ?></p>
