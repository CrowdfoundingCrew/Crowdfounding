          ...
          <form accept-charset="utf-8" action="#" class="simform">
            ...
            <div class="input string optional">
              ...
              <div class="input string optional">
                ...
                <input class="string optional" maxlength="255" id="onlus-tel" placeholder="Nome" type="text" size="50" />
              </div>
              <div class="input string optional">
                <label class="string optional" for="user-pw-repeat">Telefono *</label>
                <input class="string optional" maxlength="10" id="onlus-tel" placeholder="Telefono" type="text" size="50" />
              </div>
              <div class="input string optional">
                <label class="string optional" for="onlus-piva">Partita Iva *</label>
                <input class="string optional" maxlength="11" id="onlus-piva" placeholder="Partita Iva" type="text" size="50" />
              </div>
              <div class="input string optional">
                <label class="string optional" for="onlus-cf">Codice fiscale *</label>
                <input class="string optional" maxlength="16" id="onlus-cf" placeholder="Codice fiscale" type="text" size="50" />
              </div>
              <div class="input string optional">
                <label class="string optional" for="onlus-rea">REA *</label>
                <input class="string optional" maxlength="11" id="user-pw" placeholder="REA" type="text" size="50" />
              </div>
              <div class="input string optional">
                <label class="string optional" for="onlus-logo">Logo *</label>
                <input class="string optional" id="onlus-logo" type="file" size="50" />
              </div>
            </div>
